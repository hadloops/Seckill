...
class Mredis{
	...
	// 基础参数准备
	protected $host = " r-hp39ebc9067dc634.redis.huhehaote.rds.aliyuncs.com";
	protected $port = 6379;
	protected $user = "r-hp39ebc9067dc634";
	protected $pwd = "REDISpassword0123";
	protected $max = 10000;
	protected $key = 'shop';
	// 设置数据库
	protected $redis;
