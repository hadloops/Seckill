...
// 发送通知信息
function sendOver(){
	$url_level1 = 'http://level1.chanpingou.com/set_file.php';// 修改称为自己的触发位置
	$url_level2 = 'http://level2.chanpingou.com/set_file.php';// 修改称为自己的触发位置
	$url_level4 = 'http://level4.chanpingou.com/set_mysql.php';// 修改称为自己的触发位置
	// 收录完成
	// 触发第一层：
